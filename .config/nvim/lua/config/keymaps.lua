...
map("n", "<leader>k", ":FzfLua keymaps<CR>", { desc = "Keymaps", silent = true })
...
-- Resize splits
map("n", "<C-w><", ":vertical resize -25<CR>", { desc = "Decrease width", silent = true })
map("n", "<C-w>>", ":vertical resize +25<CR>", { desc = "Increase width", silent = true })
map("n", "<C-w>+", ":resize +10<CR>", { desc = "Increase height", silent = true })
map("n", "<C-w>-", ":resize -10<CR>", { desc = "Decrease height", silent = true })

-- Name:         backy
-- Description:  Light colorscheme using backgrounds for coloring

vim.cmd.highlight("clear")
vim.g.colors_name = "backy"
...
hl("CursorInsert", { bg = palette.diffplus, fg = palette.bg })
hl("lCursor", { link = "Cursor" })
hl("TermCursor", { link = "Cursor" })
vim.opt.guicursor = "n-v-c:block-Cursor,i-ci-ve:ver25-CursorInsert,r-cr:hor20-Cursor,o:hor50-Cursor"
